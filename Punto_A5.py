...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.centralwidget = QtWidgets.QWidget(MainWindow)#A
        self.centralwidget.setObjectName("centralwidget")#u
        self.label = QtWidgets.QLabel(self.centralwidget)#s
        self.label.setGeometry(QtCore.QRect(450, 460, 311, 71))#z
        self.label.setStyleSheet("border-image: url(:/cct/logo ECCI.jpg);")#u
        self.label.setText("")
        ...
        self.label_3 = QtWidgets.QLabel(self.centralwidget)#d
        self.label_3.setGeometry(QtCore.QRect(310, 40, 461, 361))#r
        self.label_3.setText("")#q
        self.label_3.setObjectName("label_3")#c
